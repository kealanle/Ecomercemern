...
export const reducerUsuarioRegistro = (state = {}, action) => {
  switch (action.type) {
...
export const reducerUsuarioDetalles = (state = { usuario: {} }, action) => {
  switch (action.type) {
...
export const reducerUsuarioActualizarPerfil = (state = {}, action) => {
  switch (action.type) {
